...
import com.example.commande_pc.databinding.UploadRequesterAndStockBinding;
...
public class UploadRequesterAndStock extends Fragment {
    private UploadRequesterAndStockBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding=UploadRequesterAndStockBinding.inflate(inflater,container,false);
        ajouterFichier=binding.buttonAjouterUnFichier2;
        reinitialiser=binding.buttonReinitialiser2;
        votrefichier=binding.attachmentPath2;
        ...
        reinitialiser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.reinitilizeRequesterAndStock(file);
